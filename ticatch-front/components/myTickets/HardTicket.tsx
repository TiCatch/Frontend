...
const HardTicket = ({
  ...
  return (
    <div
      ...
      <Image
        src={ticketImage.HARD}
        width={182}
        height={280}
        alt="hard ticket image"
      />
      <div className="absolute left-1/2 top-[142px] flex h-[104px] -translate-x-1/2 -translate-y-1/2 flex-col gap-[12px] whitespace-nowrap text-center text-2xl font-bold leading-none text-sub-6">
        {section}구역
        <div>
          {row}열 {col}번
        </div>
