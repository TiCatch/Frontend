export const TERMS_OF_KAKAOPAY = `카카오페이 전자금융거래 이용약관
제1조 (목적)
...
① ‘선불전자지급수단’이라 함은 회사가 운영하는 웹사이트 및 제휴사 서비스 등에서 재화 또는 용역(이하 ‘재화 등’이라고 합니다)을 구매할 수 있는 카카오페이머니 및 카카오페이상품권(이하 '구매선불'이라 합니다), 카카오페이포인트(이하 '적립선불'이라 합니다) 등과 같이 회사가 발행 당시 미리 회원에게 공지한 전자금융거래법 상 선불전자지급수단을 말합니다. 선불전자지급수단에 관한 구체적인 사항은 카카오페이 이용약관 및 카카오페이상품권 이용약관에서 정한 바에 따릅니다.
...
제24조 (선불전자지급수단의 이용)
① 회원은 회사가 정한 유효기한 및 이용방법에 따라 선불전자지급수단을 이용할 수 있으며, 회사는 그 구체적인 사항을 본 약관, 카카오페이 이용약관, 카카오페이상품권 이용약관 또는 선불전자지급수단 관련 서비스 페이지를 통해 공지합니다.
...
제25조 (선불전자지급수단의 유효기간)
① 회사가 발행하는 선불전자지급수단의 유효기간은 각 선불전자지급수단별로 상이합니다. 구체적인 사항은 카카오페이 이용약관 및 카카오페이상품권 이용약관에서 정한 바를 따릅니다.

② 회사는 전항에 따라 선불전자지급수단의 유효기간이 도래하여 소멸되기 전에 회원에게 소멸예정 사실을 전자우편 등의 방법으로 통지합니다. 구매선불의 경우 유효기간이 도래하기 30일 전 통지를 포함하여 3회 이상 이용자에게 유효기간의 도래 예정 사실 및 환급 방법 등을 통지합니다. 구체적인 사항은 카카오페이 이용약관 및 카카오페이상품권 이용약관에서 정한 바를 따릅니다.

제26조 (선불전자지급수단의 환급)
① 회원은 보유 중인 선불전자지급수단의 환급을 회사에 요구할 경우 구매선불 전액을 환급 받을 수 있습니다. 다만, 회사로부터 무상 제공받은 적립선불의 경우 환급 대상에서 제외되며, 구체적인 사항은 카카오페이 이용약관을 따릅니다. 카카오페이상품권의 경우에는 별도의 이용약관에서 정한 바에 따릅니다.
...
5. 회사가 회원에게 불리하게 선불전자지급수단을 이용할 수 있는 가맹점을 축소하거나 선불전자지급수단의 이용 조건을 변경하는 경우. 단, 가맹점 폐업, 가맹계약기간의 만료, 그 밖에 다음 각 목의 경우에는 그러하지 아니합니다.
...
다. 선불전자지급수단을 이용할 수 있는 가맹점을 축소하더라도 선불전자지급수단을 이용할 수 있는 다른 가맹점이 충분하여 가맹점이 제공하는 재화·용역을 구입하려는 회원의 이익을 저해할 우려가 없는 경우
